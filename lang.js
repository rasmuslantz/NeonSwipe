...
const L = {
  en: {
    ...
    p_ads_d:"The app needs an internet connection to load ads. Your photo/video content is never sent with ad requests. Ad providers may receive device identifiers and coarse information (like language, region) required to deliver and measure ads under their own policies.",
    ...
    p_third_d:"When you interact with ads or make a purchase, the relevant partners (ad networks, Apple, Google) process your data under their own policies. We encourage you to review those policies in the App Store or Google Play listings.",
    ...
    p_contact_t:"Contact",
    p_contact_d:"Questions about privacy? Email <a href=\"mailto:support@neonswipe.app\">support@neonswipe.app</a>.",
  ...
  es: {
    ...
    p_intro:"Neon Swipe está diseñado para respetar tu privacidad. En este aviso explicamos nuestras prácticas de forma clara.",
    ...
    p_ads_d:"La app necesita conexión a internet para cargar anuncios. Tu contenido de fotos/vídeos nunca se envía con las solicitudes de anuncios. Los proveedores pueden recibir identificadores del dispositivo e información general (idioma, región) necesarios para ofrecer y medir anuncios según sus políticas.",
    ...
    p_security_d:"Aplicamos salvaguardas estándar del sector a cualquier dato limitado que mantengamos (p. ej., correos de soporte). Cuando es posible, los datos se cifran en tránsito y en reposo.",
    p_third_t:"Terceros",
    p_third_d:"Cuando interactúas con anuncios o realizas una compra, los socios implicados (redes publicitarias, Apple, Google) procesan tus datos bajo sus propias políticas. Te invitamos a revisarlas en App Store o Google Play.",
    ...
    p_contact_d:"¿Preguntas sobre privacidad? Escribe a <a href=\"mailto:support@neonswipe.app\">support@neonswipe.app</a>.",
...
function setLocale(loc){
  ...
  if(iosImg){ if(loc==="es"&&window.locales.es_has_badges){ iosImg.src="img/badge-appstore-es.png"; iosImg.alt="Descárgalo en el App Store"; } else { iosImg.src="img/badge-appstore-en.png"; iosImg.alt="Download on the App Store"; } }
  if(andImg){ if(loc==="es"&&window.locales.es_has_badges){ andImg.src="img/badge-google-es.png"; andImg.alt="Disponible en Google Play"; } else { andImg.src="img/badge-google-en.png"; andImg.alt="Get it on Google Play"; } }
...
/* Infinite auto-slide rail; pauses on hover/focus/drag */
...
(function init(){
  ...
  if(isIOS&&iosBtn&&andBtn){ iosBtn.style.order=0; andBtn.style.order=1; } else if(iosBtn&&andBtn){ iosBtn.style.order=1; andBtn.style.order=0; }
  ...
  // Pricing controls (informational)
