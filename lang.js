...
const L = {
  ...
  es: {
    ...
    f_zoom_t:"Zoom y reproducción", f_zoom_d:"Acércate con gesto a las fotos o reproduce vídeos para elegir los mejores momentos.",
    ...
    p_ads_t:"Publicidad y conectividad", p_ads_d:"La app necesita conexión a internet para cargar anuncios. Tu contenido nunca se envía con las solicitudes de anuncios. Los proveedores pueden recibir identificadores del dispositivo e información general (idioma, región) para ofrecer y medir anuncios según sus políticas.",
    ...
    p_region_t:"Transferencias internacionales", p_region_d:"Debido a que la publicidad y la facturación las prestan plataformas globales, tu información puede procesarse fuera de tu país. Esos proveedores aplican sus propias garantías para dichas transferencias.",
...
/* Infinite auto-scroll rail (loop), pause on hover/focus/drag */
function initInfiniteRail(rail){
  if(!rail) return;
  rail.innerHTML += rail.innerHTML; // duplicate
